...
from ..EventCore.eventManager import Event

from ..log import logger
from ..Model.WsModel import Authorization, Load, opcode


class wsc:
    """ws客户端实现"""

    def __init__(self, url: str, token: str, eventManager: Any, shard: list[int],s:int | None = None,session: str | None = None) -> None:
        self.ws = None
        self.path = url
        self.token = token
        self.shard = shard
